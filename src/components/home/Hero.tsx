    ...
    <section className="bg-white">
      <Container className="pt-16 sm:pt-20 lg:pt-28">
        <Reveal>
          ...
          <h1 className="mt-6 max-w-4xl text-4xl font-black leading-[1.08] tracking-tight text-black sm:text-5xl lg:text-6xl">
      ...
      <Container className="mt-16 sm:mt-20">
        <Reveal delay={150}>
          <div className="grid grid-cols-2 gap-x-6 gap-y-10 border-t border-black/10 pt-10 sm:grid-cols-4">
            {stats.map((s) => (
              <div key={s.label}>
                <p className="font-black text-3xl text-black sm:text-4xl tracking-tight">{s.value}</p>
